    ...
    <div class="mt-12">
        <form @submit.prevent="updateAppliance($route.params.id)">
            <div class="mb-6 px-5">
                ...
                <input v-model="appliance.name" type="text" placeholder="Geladeira Eletrolux" id="name" class="block w-full p-4 text-gray-700 border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="mb-6 px-5">
                ...
                <input v-model="appliance.description" type="text" placeholder="Economia garantida." id="description" class="block w-full p-4 text-gray-700 border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="mb-6 px-5">
                ...
                <select v-model="appliance.eletric_tension" id="eletric_tension" class="block w-full p-4 text-gray-700 border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="mb-6 px-5">
                ...
                <select id="brand_id" v-model="appliance.brand_id" class="block w-full p-4 text-gray-700 border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500">
